...
function Comment({ token, clickedAgendaId, onChange, RoomName }) {

    const [comments, setComments] = useState();

    useEffect(() => {
        // axios
        //     .get(`${process.env.REACT_APP_HOST_URL}/comment/${clickedAgendaId}/option`, {
        //         headers: {
    ...
    function commentWrite() {
        ...
        axios
            .post(`${process.env.REACT_APP_HOST_URL}/comment/${clickedAgendaId}/option`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
                contents: Input,
